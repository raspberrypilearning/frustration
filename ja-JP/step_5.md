...
![スクリーンショット](images/frustration-wand-bend.png)

+ You can then twist the two pieces of wire together.

![スクリーンショット](images/frustration-wand-twist.png)
...
![スクリーンショット](images/frustration-course-bend.png)
...
![スクリーンショット](images/frustration-course-putty.png)
...
![スクリーンショット](images/frustration-gnd-connect.png)

+ You can then connect Pin 0 to your wand.

![スクリーンショット](images/frustration-pin0-connect.png)
...
![スクリーンショット](images/frustration-final.png)