...
![스크린샷](images/frustration-pin0-x.png)
...
![스크린샷](images/frustration-pin0-fails.png)

+ Finally, you can add code to display the updated number of fails. 코드는 다음과 같이 설계되어야 합니다.
...
![스크린샷](images/frustration-pin0-test.png)
...
![스크린샷](images/frustration-pin0-compile.png)